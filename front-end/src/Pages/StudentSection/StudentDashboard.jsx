...
const StudentDashboard = () => {
  ...
  const { data, isFetching, lineChartData, lineChartOptions, semestre } =
    useSelector((state) => ({
      ...
      <div>
        ...
        <div className="w-full min-h-[384px]  rounded-lg bg-slate-100 dark:bg-slate-900 my-6 relative ">
          <p className="text-center font-bold text-xl py-6 flex flex-col items-center justify-center">
            ...
            {isFetching && (
              <CircleLoader white={"dark:stroke-white"} options={"w-12 h-12"} />
            )}
          </p>
...
function LineChartSkeleton({}) {
  return (
    <div className="w-full h-[280px] wave">
...
function DropdownClasses() {
  ...
  const { semestre, data } = useSelector((state) => ({
    ...state.StudentDashboardReducer,
    ...state.AuthReducer,
  }));
