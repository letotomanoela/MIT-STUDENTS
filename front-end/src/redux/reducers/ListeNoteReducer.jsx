...
export const getNotes = (classe, asc, skip) => (dispatch) => {
  try {
    ...
    fetch(
      `/api/note/asc/${asc}/classe/${classe}/skip=${
        (Number(skip) - 1) * 10
      }`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem("TOKEN")}`,
...
export const getTotalNotes = (classe, asc) => (dispatch) => {
  ...
  fetch(
    `/api/etudiant/nombre/total/asc/${asc}/classe/${classe}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("TOKEN")}`,
      },
    }
...
export const searchNotes = (classe, asc, skip, value) => (dispatch) => {
  try {
    ...
    fetch(
      `/api/note/research=${value}/asc=${asc}/classe=${classe}/skip=${
        (Number(skip) - 1) * 10
      }`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem("TOKEN")}`,
...
export const getTotalSearchNotes = (classe, asc, val) => (dispatch) => {
  ...
  fetch(
    `/api/note/total/research=${val}/asc=${asc}/classe=${classe}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("TOKEN")}`,
      },
    }
